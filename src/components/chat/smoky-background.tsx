...
export function SmokyBackground() {
  ...
  // In light mode, use very subtle effects — no dark smoky look
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background: isDark
            ? 'radial-gradient(ellipse at center, rgba(160, 195, 255, 0.07) 0%, rgba(120, 165, 255, 0.04) 30%, rgba(80, 130, 255, 0.015) 60%, transparent 80%)'
            : 'radial-gradient(ellipse at center, rgba(139, 92, 246, 0.04) 0%, rgba(139, 92, 246, 0.02) 30%, transparent 60%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background: isDark
            ? 'radial-gradient(ellipse at center, rgba(100, 160, 255, 0.05) 0%, rgba(70, 120, 255, 0.025) 40%, transparent 70%)'
            : 'radial-gradient(ellipse at center, rgba(6, 182, 212, 0.03) 0%, transparent 50%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background: isDark
            ? 'radial-gradient(ellipse at center, rgba(100, 80, 200, 0.03) 0%, transparent 60%)'
            : 'radial-gradient(ellipse at center, rgba(139, 92, 246, 0.02) 0%, transparent 50%)',
        }}
      />

      {/* Centered logo watermark — only in dark mode */}
      {isDark && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative">
            ...
            {/* The actual logo — semi-transparent */}
            <img
              src="/logo-full.webp"
              alt=""
      ...
      {/* Light mode: very subtle logo watermark */}
      {!isDark && (
        <div className="absolute inset-0 flex items-center justify-center">
          <img
            src="/logo-full.webp"
            alt=""
            className="w-[40vmin] h-[40vmin] object-contain opacity-[0.03]"
          />
        </div>
      )}
    </div>
